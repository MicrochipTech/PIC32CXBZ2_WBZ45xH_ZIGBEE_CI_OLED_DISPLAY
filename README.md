...
Features: **| ZIGBEE | OLED | MULTISENSOR |**
...
| Note: Remove the R169, R94 & R95 0ohm resistor from the WBZ451HPE Curiosity Board!! |
| --- |
...
### Getting started with ZIGBEE CI and OLED DISPLAY with WBZ451HPE Curiosity Development Board.
...
- Again right click on the "⬦" in TIME->TMR and add the satisfier "TC1" to add the component.
...
- In your MPLAB Harmony v3 based application go to "firmware\src\app_user_edits.c", make sure the changes are implemented and the below code line is commented.
